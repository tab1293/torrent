...
[![Join the chat at https://gitter.im/tab1293/torrent](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/tab1293/torrent?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![GoDoc](https://godoc.org/github.com/tab1293/torrent?status.svg)](https://godoc.org/github.com/tab1293/torrent)
[![CircleCI](https://circleci.com/gh/tab1293/torrent.svg?style=shield)](https://circleci.com/gh/tab1293/torrent)
 ...
 * [bencode](https://godoc.org/github.com/tab1293/torrent/bencode)
 * [tracker](https://godoc.org/github.com/tab1293/torrent/tracker)

## Installation

Install the library package with `go get github.com/tab1293/torrent`, or the provided cmds with `go get github.com/tab1293/torrent/cmd/...`.

## Library examples

There are some small [examples](https://godoc.org/github.com/tab1293/torrent#pkg-examples) in the package documentation.
...
Communication about the project is primarily through [Gitter](https://gitter.im/tab1293/torrent) and the [issue tracker](https://github.com/tab1293/torrent/issues).
...
Downloads torrents from the command-line. This first example does not use `godo`.
	...
	$ go get github.com/tab1293/torrent/cmd/torrent
...
torrentfs mounts a FUSE filesystem at `-mountDir`. The contents are the torrents described by the torrent files and magnet links at `-metainfoDir`. Data for read requests is fetched only as required from the torrent network, and stored at `-downloadDir`.
    ...
    $ mkdir mnt torrents
    $ godo github.com/tab1293/torrent/cmd/torrentfs -mountDir=mnt -metainfoDir=torrents &
    $ cd torrents
...
Creates a magnet link from a torrent file. Note the extracted trackers, display name, and info hash.
    ...
    $ godo github.com/tab1293/torrent/cmd/torrent-magnet < ubuntu-14.04.2-desktop-amd64.iso.torrent
